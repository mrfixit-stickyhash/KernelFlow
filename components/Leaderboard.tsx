...
import { Trophy, User, Bot, Loader2 } from 'lucide-react';
...
const Leaderboard: React.FC<LeaderboardProps> = ({ supabaseLevelId, refreshTrigger }) => {
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-1">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="text-xs">
            {rows.map((row) => (
              <tr key={row.rn} className="border-b border-cyber-700/30 hover:bg-cyber-700/20 transition-colors">
